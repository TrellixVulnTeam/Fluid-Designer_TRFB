...
class Doors(fd.Library_Assembly):
    ...
    def draw(self):
        ...
        if self.false_front_qty > 0:
            false_front = self.add_assembly(PART_WITH_EDGEBANDING)  
            ...
            if self.false_front_qty > 1:
                false_front_2 = self.add_assembly(PART_WITH_EDGEBANDING)
        ...
        #LEFT DOOR
        left_door = self.add_assembly(PART_WITH_EDGEBANDING)
        ...
        #RIGHT DOOR
        right_door = self.add_assembly(PART_WITH_EDGEBANDING)  
...
class Drawers(fd.Library_Assembly):
    ...
    def get_assemblies(self,name):
        ...
        front = self.add_assembly(PART_WITH_EDGEBANDING)
...
class Horizontal_Drawers(fd.Library_Assembly):
    ...
    def draw(self):
        ...
        division.cutpart("Base_Division")
...
class FF_Horizontal_Drawers(fd.Library_Assembly):
    ...
    def draw(self):
        ...
        left_front = self.add_assembly(PART_WITH_EDGEBANDING)
        ...
        left_front.obj_bp.mv.is_cabinet_door = True
        
        right_front = self.add_assembly(PART_WITH_EDGEBANDING)
        ...
        right_front.obj_bp.mv.is_cabinet_door = True
