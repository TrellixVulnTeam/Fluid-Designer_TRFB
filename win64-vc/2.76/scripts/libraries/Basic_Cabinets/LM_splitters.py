...
PART_WITH_EDGEBANDING = os.path.join(os.path.dirname(__file__),"Parts","Part with Edgebanding.blend")
        ...
        if self.assembly.obj_bp:
            ...
            if self.assembly.obj_bp.name in context.scene.objects:
                ...
                if opening_1:
                    ...
                    if opening_1.equal:
                        row.label(str(utils.meter_to_active_unit(opening_1.DistanceValue)))
                ...
                if opening_2:
                    ...
                    if opening_2.equal:
                        row.label(str(utils.meter_to_active_unit(opening_2.DistanceValue)))
                ...
                if opening_3:
                    ...
                    if opening_3.equal:
                        row.label(str(utils.meter_to_active_unit(opening_3.DistanceValue)))
                ...
                if opening_4:
                    ...
                    if opening_4.equal:
                        row.label(str(utils.meter_to_active_unit(opening_4.DistanceValue)))
