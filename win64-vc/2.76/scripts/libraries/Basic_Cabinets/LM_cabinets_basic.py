...
BASE_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Base_Carcass.blend")
BASE_DIAGONAL_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Base_Diagonal_Carcass.blend")
BASE_OUTSIDE_CORNER_CHAMFERED_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Base_Outside_Corner_Chamfered_Carcass.blend")
BASE_OUTSIDE_CORNER_RADIUS_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Base_Outside_Corner_Radius_Carcass.blend")
BASE_PIE_CUT_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Base_Pie_Cut_Carcass.blend")
BASE_TRANSITION_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Base_Transition_Carcass.blend")
SINK_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Sink_Carcass.blend")
SUSPENDED_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Suspended_Carcass.blend")
TALL_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Tall_Carcass.blend")
TALL_OUTSIDE_CORNER_CHAMFERED_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Tall_Outside_Corner_Chamfered_Carcass.blend")
TALL_OUTSIDE_CORNER_RADIUS_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Tall_Outside_Corner_Radius_Carcass.blend")
TALL_TRANSITION_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Tall_Transition_Carcass.blend")
UPPER_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Upper_Carcass.blend")
UPPER_DIAGONAL_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Upper_Diagonal_Carcass.blend")
UPPER_OUTSIDE_CORNER_CHAMFERED_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Upper_Outside_Corner_Chamfered_Carcass.blend")
UPPER_OUTSIDE_CORNER_RADIUS_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Upper_Outside_Corner_Radius_Carcass.blend")
UPPER_PIE_CUT_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Upper_Pie_Cut_Carcass.blend")
UPPER_TRANSITION_CARCASS = os.path.join(os.path.dirname(__file__),"Carcasses","Upper_Transition_Carcass.blend")

#----------SHELF ASSEMBLIES
SHELVES = os.path.join(os.path.dirname(__file__),"Shelves","Shelves.blend")
SHELVES_CHAMFERED = os.path.join(os.path.dirname(__file__),"Shelves","Shelves_Chamfered.blend")
SHELVES_DIAGONAL = os.path.join(os.path.dirname(__file__),"Shelves","Shelves_Diagonal.blend")
SHELVES_PIE_CUT = os.path.join(os.path.dirname(__file__),"Shelves","Shelves_Pie_Cut.blend")

BLIND_PANEL = os.path.join(os.path.dirname(__file__),"Parts","Part with Edgebanding.blend")
MICROWAVE = os.path.join(os.path.dirname(__file__),"Appliances","Conventional Microwave.blend")
VENT = os.path.join(os.path.dirname(__file__),"Appliances","Wall Mounted Range Hood 01.blend")

#----------PRODUCT BASE CLASSES
class Basic_Standard(fd_types.Assembly):
    """ Standard Basic Cabinet
    """
    
    property_id = "basic_cabinets.basic_cabinet_prompts"
    
    plan_draw_id = "cabinet.draw_plan"
    type_assembly = "PRODUCT"

    """ Type:fd_type.Assembly - The main carcass used """
    carcass = None
    ...
    """ Type:fd_type.Assembly - Splitter insert to add to the cabinet """
    splitter = None
    
    """ Type:fd_type.Assembly - Interior insert to add to the cabinet """
    interior = None
    
    """ Type:fd_type.Assembly - Exterior insert to add to the cabinet """
    exterior = None
...
class Inside_Corner(fd_types.Assembly):
    ...
    def add_pie_cut_doors(self):
        ...
        if self.carcass_type == "Base":
            ...
            self.exterior.z_dim('fabs(Height)-Toe_Kick_Height-Material_Thickness*2',[Height,Toe_Kick_Height,Material_Thickness])  
...
class Blind_Corner(fd_types.Assembly):
    ...
    def draw(self):
        g = bpy.context.scene.lm_basic_cabinets
        self.create_assembly()
        ...
        self.add_prompt(name="Blind Panel Thickness",prompt_type='DISTANCE',value=unit.inch(.75),tab_index=1)
        ...
        blind_panel.material("Basic_Cabinet_Material")
...
class PRODUCT_1_Door_Base(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.exterior = LM_exteriors.Doors()
        self.exterior.door_type = "Base"
        self.exterior.door_swing = 'Left Swing'
...
class PRODUCT_2_Door_Base(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.exterior = LM_exteriors.Doors()
        self.exterior.door_type = "Base"
        self.exterior.door_swing = 'Double Door'
        self.interior = SHELVES     
...
class PRODUCT_2_Door_with_False_Front_Sink(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.exterior.door_type = "Base"
        self.exterior.door_swing = 'Double Door'
        self.exterior.false_front_qty = 1
        self.interior = None       
...
class PRODUCT_2_Door_2_False_Front_Sink(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.exterior.door_type = "Base"
        self.exterior.door_swing = 'Double Door'
        self.exterior.false_front_qty = 2
        self.interior = None         
...
class PRODUCT_1_Door_1_Drawer_Base(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.splitter.opening_1_height = g.Top_Drawer_Front_Height - unit.inch(1)
        self.splitter.exterior_1 = LM_exteriors.Drawers()
        self.splitter.exterior_1.drawer_qty = 1
        self.splitter.exterior_1.prompts = {'Half Overlay Bottom':True}
        self.splitter.interior_2 = None
        self.splitter.exterior_2 = LM_exteriors.Doors()
        self.splitter.exterior_2.door_type = 'Base'
        self.splitter.exterior_2.door_swing = "Left Swing"
...
class PRODUCT_2_Door_2_Drawer_Base(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.splitter = LM_splitters.INSERT_2_Vertical_Openings()
        self.splitter.opening_1_height = g.Top_Drawer_Front_Height - unit.inch(1)
        self.splitter.exterior_1 = LM_exteriors.Horizontal_Drawers()
        self.splitter.exterior_1.prompts = {'Half Overlay Bottom':True}
        self.splitter.interior_2 = None
        self.splitter.exterior_2 = LM_exteriors.Doors()
        self.splitter.exterior_2.door_type = "Base"
        self.splitter.exterior_2.door_swing = 'Double Door'
        self.splitter.exterior_2.prompts = {'Half Overlay Top':True}    
...
class PRODUCT_Microwave_2_Drawer_Base(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.carcass_type =  "Base"
        self.splitter = LM_splitters.INSERT_2_Vertical_Openings()
        self.splitter.exterior_2 = LM_exteriors.Drawers()
        self.splitter.exterior_2.drawer_qty = 2               
...
class PRODUCT_1_Drawer(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.carcass_path = BASE_CARCASS
        self.carcass_type =  "Base"
        self.exterior = LM_exteriors.Drawers()
...
class PRODUCT_2_Drawer_Suspended(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.carcass_type =  "Suspended"
        self.height_above_floor = g.Base_Cabinet_Height
        self.exterior = LM_exteriors.Horizontal_Drawers()   
...
class PRODUCT_1_Double_Door_Tall(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.carcass_type = "Tall"
        self.splitter = LM_splitters.INSERT_2_Vertical_Openings()
        self.splitter.exterior_1 = LM_exteriors.Doors()
        self.splitter.exterior_1.door_type = "Upper"
        self.splitter.exterior_1.door_swing = "Left Swing"
        self.splitter.exterior_1.prompts = {'Half Overlay Bottom':True}
        self.splitter.interior_2 = None
        self.splitter.exterior_2 = LM_exteriors.Doors()
        self.splitter.exterior_2.door_type = "Tall"
        self.splitter.exterior_2.door_swing = "Left Swing"
        self.splitter.exterior_2.prompts = {'Half Overlay Top':True}        
...
class PRODUCT_2_Double_Door_Tall(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.splitter.exterior_1 = LM_exteriors.Doors()
        self.splitter.exterior_1.door_type = "Upper"
        self.splitter.exterior_1.door_swing = "Double Door"
        self.splitter.exterior_1.prompts = {'Half Overlay Bottom':True}
        self.splitter.interior_2 = None
        self.splitter.exterior_2 = LM_exteriors.Doors()
        self.splitter.exterior_2.door_type = "Tall"
...
class PRODUCT_1_Double_Door_Upper(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.splitter.exterior_2 = LM_exteriors.Doors()
        self.splitter.exterior_2.door_swing = "Left Swing"
        self.splitter.exterior_2.door_type = "Upper"
        self.splitter.exterior_2.prompts = {'Half Overlay Top':True}
...
class PRODUCT_2_Door_Upper_with_Vent(Basic_Standard):
    ...
    def __init__(self):
        ...
        self.width = g.Width_2_Door
        self.height = g.Upper_Cabinet_Height - unit.inch(20)
        self.depth = g.Upper_Cabinet_Depth
        self.mirror_z = True
        self.height_above_floor = g.Height_Above_Floor
        self.carcass_path = UPPER_CARCASS
...
class PRODUCT_Pie_Cut_Corner_Base(Inside_Corner):
    ...
    def __init__(self):
        ...
        self.exterior = LM_exteriors.Pie_Cut_Doors()
        self.exterior.door_type = "Base"
        self.interior = None
...
def register():
    ...
    bpy.types.Scene.lm_basic_cabinets = bpy.props.PointerProperty(type = PROPERTIES_Scene_Variables)
